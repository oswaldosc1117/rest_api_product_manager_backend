...
describe('GET /api/products/:id', () => {
    it('Should return a 404 response forn a non-existent product', async () => {
...
describe('PUT /api/products/:id', () => {
    ...
    it('should check a valid ID in the URL', async () => {
        const response = await request(server).put('/api/products/ot-valid-url').send({
            name: "producto",
            price: 300,
            availability: true
        })
